...
struct BridgeConfig: Codable {
    ...
    init(webModeEnabled: Bool, serverURL: String, username: String, role: String, locationInjectionEnabled: Bool, signedIn: Bool) {
...
final class BridgeClient {
    ...
    func register(serverURL: String, username: String, password: String) async throws -> String {
        ...
        if let ok = json["ok"] as? Bool, ok {
            return json["message"] as? String ?? "Student registration sent. A teacher must approve this account."
        }
